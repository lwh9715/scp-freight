...
public class TreeDataProvider  extends TreeDataProviderAdapter {
	...
	public TreeDataProvider(String roleid , MultiLanguageBean l,String company) {
		try {
			this.l = l ;
	...
	private void initTreeLevel1(Long pid , String roleid, String company) throws Exception {
		String querySql = "SELECT * FROM f_sys_corporation_framework('company="+company+";type=company')";
