package com.scp.view.sysmgr.dept;
...
@ManagedBean(name = "pages.sysmgr.dept.deptBean", scope = ManagedBeanScope.REQUEST)
public class DeptBean extends GridFormView{
...
//		SysCorporation corporation = (SysCorporation)sysCorporationDao.findAllByClauseWhere("iscustomer = 'N'").get(0);
	...
	public void delGrid(){
		...
		if (ids == null || ids.length == 0 || ids.length > 1) {
			...
			this.serviceContext.sysDeptService.removeDates(ids);
			refresh();
		}
	}
