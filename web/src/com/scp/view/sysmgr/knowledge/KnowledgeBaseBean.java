package com.scp.view.sysmgr.knowledge;
...
@ManagedBean(name = "pages.sysmgr.knowledge.knowledgeBaseBean", scope = ManagedBeanScope.REQUEST)
public class KnowledgeBaseBean extends GridFormView {
	...
	public void saveAction(){
		...
		String libtype = AppUtils.getReqParam("libtype");
