...
@ManagedBean(name = "pages.module.oa.staffmgr.userlogchangeBean", scope = ManagedBeanScope.REQUEST)
public class UserLogChangeBean extends MastDtlView {

	@Bind
	@SaveState
	@Accessible
	public  UserChange selectedRowData = new UserChange();

	@Bind
	public UIWindow showLogChangeWindow;
	...
	public void init() {
		selectedRowData = new UserChange();
	...
	public void dels() {
		...
		try {
			for (String id : ids) {
				serviceContext.userChangeService().removeDate(Long
						.valueOf(id));
			}
			this.alert("OK");
			this.grid.reload();
	...
	public void doServiceSaveMaster() {
		serviceContext.userChangeService().saveData(this.selectedRowData);
	...
	public void refreshMasterForm() {
		this.selectedRowData = serviceContext.userChangeService().userChangeDao
				.findById(this.mPkVal);
		update.markUpdate(true, UpdateLevel.Data, "masterEditPanel");
		update.markUpdate(true, UpdateLevel.Data, "mPkVal");
		update.markUpdate(true, UpdateLevel.Data, "place");
	...
	public void delMaster() {
		serviceContext.userChangeService().userChangeDao
