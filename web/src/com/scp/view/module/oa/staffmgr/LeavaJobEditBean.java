...
@ManagedBean(name = "pages.module.oa.staffmgr.leavajobeditBean", scope = ManagedBeanScope.REQUEST)
public class LeavaJobEditBean extends MastDtlView {
	...
	public void delLeava() {
		this.serviceContext.jobChangeService().removeDate(this.selectedRowData
				.getId());
	...
	public void addMaster() {
		...
		selectedRowData.setChangetype("D");
	}
