...
@ManagedBean(name = "pages.module.customer.custcareBean", scope = ManagedBeanScope.REQUEST)
public class CustCareBean extends GridFormView {

	@SaveState
	@Accessible
	public SysCorpcare selectedRowData = new SysCorpcare();
	...
	public void grid_ondblclick() {
		...
		if (editWindow != null) {
			editWindow.show();
			contactedit.load("./custcareedit.xhtml?id=" + this.pkVal);
		}
	}
	...
	public void beforeRender(boolean isPostBack) {
		...
		selectedRowData = new SysCorpcare();
	...
	@Override
	public void save() {
		serviceContext.customerCareMgrService.saveData(selectedRowData);
		this.alert("OK");
		this.refresh();
	}
	...
	public void add() {
		...
		if (editWindow != null) {
			editWindow.show();
			contactedit.load("./custcareedit.xhtml?customerid=" + this.customerid);
		}
	...
	public void delBatch() {
		...
		try {
			serviceContext.customerCareMgrService.delBatch(ids);
