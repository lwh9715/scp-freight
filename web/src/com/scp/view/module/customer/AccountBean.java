...
@ManagedBean(name = "pages.module.customer.accountBean", scope = ManagedBeanScope.REQUEST)
public class AccountBean extends GridFormView {
	...
	public void grid_ondblclick() {
		...
		if (editWindow != null) {
			editWindow.show();
			/*contactedit.load("./accountedit.xhtml?id=" + this.pkVal);*/
			contactedit.load("./accountedit.xhtml?id="+ this.pkVal +"&customerid="+customerid);
		}
	...
	public void add() {
		...
		if (editWindow != null) {
			editWindow.show();
			contactedit.load("./accountedit.xhtml?customerid=" + this.customerid);
		}
	...
	public void delBatch() {
		...
		try {
			serviceContext.customerAccountMgrService.delBatch(ids);
