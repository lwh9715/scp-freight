...
@ManagedBean(name = "pages.module.customer.custlibcustBean", scope = ManagedBeanScope.REQUEST)
public class CustLibCustBean extends GridView {
	...
	public void del() {
		...
		this.serviceContext.custLibMgrService.removeCust(libid,ids);
		this.alert("OK!");
		this.grid.reload();
	...
	public void chooseBtn() {
		...
		this.serviceContext.custLibMgrService.addCust(libid,ids);
		this.alert("OK!");
		this.grid.reload();
		this.gridFrom.reload();
	}
