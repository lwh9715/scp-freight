...
@ManagedBean(name = "pages.module.customer.custserviceBean", scope = ManagedBeanScope.REQUEST)
public class CustServiceBean extends GridFormView {
	...
	public void grid_ondblclick() {
		...
		if (editWindow != null) {
			editWindow.show();
			contactedit.load("./custserviceedit.xhtml?id=" + this.pkVal);
		}
	...
	public void add() {
		...
		if (editWindow != null) {
			editWindow.show();
			contactedit.load("./custserviceedit.xhtml?customerid=" + this.customerid);
		}
