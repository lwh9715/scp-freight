...
@ManagedBean(name = "pages.module.customer.custcareeditBean", scope = ManagedBeanScope.REQUEST)
public class CustCareEditBean extends GridFormView {
	...
	public void beforeRender(boolean isPostBack) {
		if (!isPostBack) {
			...
			selectedRowData = serviceContext.customerCareMgrService.sysCorpcareDao
					.findById(pkid);
	...
	public void del() {
		if(this.pkid==-1l){
			...
			serviceContext.customerCareMgrService.removeDatedel(this.pkid);
