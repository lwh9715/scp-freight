...
@ManagedBean(name = "pages.module.order.busorderlistCheckBean", scope = ManagedBeanScope.REQUEST)
public class BusOrderListCheckBean extends GridView {
...
//			this.qryRefresh();
	...
	public void checkBatch() {
		...
		try {
			...
			serviceContext.busOrderMgrService.checkBatchById(list);
			Browser.execClientScript("showmsg()");
			this.refresh();
		} catch (Exception e) {
			MessageUtils.showException(e);
	...
	public void cancelCheckBatch() {
		...
		try {
			...
			serviceContext.busOrderMgrService.cancelCheckBatchById(list);
			Browser.execClientScript("showmsg()");
			this.refresh();
		} catch (Exception e) {
			MessageUtils.showException(e);
