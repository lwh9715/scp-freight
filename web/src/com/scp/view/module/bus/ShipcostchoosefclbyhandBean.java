...
@ManagedBean(name = "pages.module.bus.shipcostchoosefclbyhandBean", scope = ManagedBeanScope.REQUEST)
public class ShipcostchoosefclbyhandBean extends GridFormView {
    ...
    public void beforeRender(boolean isPostBack) {
        ...
        String jobidstr = AppUtils.getReqParam("jobidstr");
    ...
    public Map getQryClauseWhere(Map<String, Object> queryMap) {
        ...
        map.put("args", "isqryPol=" + isqryPol + ";isshipline=" + isshipline + ";pol=" + StrUtils.getSqlFormat(pol) + ";pod=" + pod + ";carrier="
                + shipping + ";line=" + line + ";qrycorpid=" + qrycorpid + ";");
    ...
    public void updatefclprice1() {
        ...
        try {
            ...
            for (String jobid : jobidstr.split(",")) {
                String sql = "SELECT f_fina_fee_imp_quote('jobid=" + jobid + ";userid=" + AppUtils.getUserSession().getUserid() + ";type=create;src=pricebyhand;priceid=" + priceid + ";bargeid=" + bargeid + ";') AS returntext;";
                Map m = serviceContext.daoIbatisTemplate.queryWithUserDefineSql4OnwRow(sql);
                String alerttext = m.get("returntext").toString();
                if (!StrUtils.isNull(alerttext)) {
                    sb.append(" ").append(alerttext);
                } else {
                    sb.append("OK");
                }
            }
