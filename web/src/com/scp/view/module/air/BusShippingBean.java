...
@ManagedBean(name = "pages.module.air.busshippingBean", scope = ManagedBeanScope.REQUEST)
public class BusShippingBean extends MastDtlView {
	...
	public BusShipSchedule shipschedule;
...
//	}
	...
	public Long getPolorPodId(String data){
		...
		if(StrUtils.isNull(data)){
			...
			qry = "SELECT id FROM dat_port WHERE code = "+data+" AND isdelete = FALSE";
		}
