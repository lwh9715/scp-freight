package com.scp.view.module.api.lenovo;
...
@ManagedBean(name = "pages.module.api.lenovo.jobsAllBean", scope = ManagedBeanScope.REQUEST)
public class JobsAllBean extends GridView {
    ...
    public void openuploadwindow() {
        uploadiframe.load("/scp/pages/module/ship/uploadtemplete.xhtml?method=importshipping&jobid="
                + 1);
