...
@ManagedBean(name = "pages.module.api.cosco.priceqryBean", scope = ManagedBeanScope.REQUEST)
	...
	public GridDataProvider getPriceApiGridProvider() {
		return new GridDataProvider() {
			...
			public Object[] getElements() {
				...
				String querySql = 
					 "\nselect  vessel||'('|| voyage ||')' AS vesvoy,  ocfamt1 ||'/'|| ocfamt2 ||'/'|| ocfamt3 || f_newline() ||ocfamt4 ||'/'|| ocfamt5 ||'/'|| ocfamt6 || f_newline() ||ocfamt7 ||'/'|| ocfamt8 ||'/'|| ocfamt9  AS ocfamt,  * from f_priceqry_json_to_recordset_cosco('"+StrUtils.getSqlFormat(priceInfo)+"')"
					+"\nORDER BY etd , id"+
