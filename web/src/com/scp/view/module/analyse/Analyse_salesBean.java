...
@ManagedBean(name = "pages.module.analyse.analyse_salesBean", scope = ManagedBeanScope.REQUEST)
public class Analyse_salesBean extends GridFormView{
	@SaveState
	@Accessible
	...
	public void report() {
		...
		argsMap.put("clienteleid", argsSale);
