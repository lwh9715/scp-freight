...
@ManagedBean(name = "pages.module.analyse.analyse_customerBean", scope = ManagedBeanScope.REQUEST)
public class Analyse_customerBean extends GridFormView{
	@SaveState
	@Accessible
...
//		String urlArgs1 = AppUtils.map2Url(argsMap, "&");
		...
		argsMap.put("language",AppUtils.getUserSession().getMlType().toString());
