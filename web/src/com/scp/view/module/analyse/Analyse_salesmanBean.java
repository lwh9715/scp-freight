...
@ManagedBean(name = "pages.module.analyse.analyse_salesmanBean", scope = ManagedBeanScope.REQUEST)
public class Analyse_salesmanBean extends GridFormView{
	@SaveState
	@Accessible
	...
	public void beforeRender(boolean isPostBack) {
		if (!isPostBack) {
			dtlIFrameClientele.setSrc("/pages/module/report/qry/dtlIFrameClientele.xhtml");
			update.markAttributeUpdate(dtlIFrameClientele, "src");
			dtlIFrameSale.setSrc("/pages/module/report/qry/dtlIFrameSale.xhtml");
