...
@ManagedBean(name = "pages.module.finance.cashier.reportBean", scope = ManagedBeanScope.REQUEST)
...
//			update.markUpdate(true, UpdateLevel.Data, "period");
	...
	public void showReport() {
		...
		String url ="";
		url= AppUtils.getRptUrl()+ "/reportJsp/showReport.jsp?raq=/finance/cashier/report.raq"+ getArgs();
