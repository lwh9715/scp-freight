...
@ManagedBean(name = "pages.module.finance.cashier.bankbillBean", scope = ManagedBeanScope.REQUEST)
public class BankBillBean extends GridView {
...
//			update.markUpdate(true, UpdateLevel.Data, "period");
	...
	public void showReport() {
		...
		String url ="";
		url= AppUtils.getRptUrl()+ "/reportJsp/showReport.jsp?raq=/finance/cashier/bankbill.raq"+ getArgs();
