...
@ManagedBean(name = "pages.module.finance.cashier.daybankBean", scope = ManagedBeanScope.REQUEST)
public class DayBankBean extends GridView {
...
//			update.markUpdate(true, UpdateLevel.Data, "period");
	...
	public void showReport() {
		...
		String url ="";
		url= AppUtils.getRptUrl()+ "/reportJsp/showReport.jsp?raq=/finance/cashier/day_bank.raq"+ getArgs();
...
//		}
	...
	@Action
	public void syncFromVch(){
		String sql = "SELECT f_fs_bank_sync('actsetid="+ AppUtils.getUserSession().getActsetid()+"')";
		Map map;
		try {
			map = this.serviceContext.fsAstMgrService.daoIbatisTemplate.queryWithUserDefineSql4OnwRow(sql);
		} catch (Exception e) {
