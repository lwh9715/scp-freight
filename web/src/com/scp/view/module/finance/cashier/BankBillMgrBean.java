...
@ManagedBean(name = "pages.module.finance.cashier.bankbillmgrBean", scope = ManagedBeanScope.REQUEST)
public class BankBillMgrBean extends GridFormView {
