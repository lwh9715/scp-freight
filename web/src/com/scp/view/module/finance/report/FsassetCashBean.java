...
@ManagedBean(name = "pages.module.finance.report.fs_asset_cashBean", scope = ManagedBeanScope.REQUEST)
public class FsassetCashBean extends GridView {
	...
	public void showReport() {
		...
		url = AppUtils.getRptUrl()
			+ "/reportJsp/showReport.jsp?raq=/finance/fs_asset_cash.raq"
			+ getArgs();
		AppUtils.openWindow("fs_asset_cash", url);
	}
