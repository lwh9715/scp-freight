...
@ManagedBean(name = "pages.module.finance.report.fs_feeBean", scope = ManagedBeanScope.REQUEST)
public class FsfeeBean extends GridView {
	...
	public void showReport() {
		...
		if(ids == null || ids.length == 0){
			url = AppUtils.getRptUrl() + "/reportJsp/showReport.jsp?raq=/finance/fs_fee.raq" + getArgs();
		}else{
			url = AppUtils.getRptUrl() + "/reportJsp/showReport.jsp?raq=/finance/fs_fee_group.raq" + getArgs() + "&astids="+StrUtils.array2List(ids);
		}
