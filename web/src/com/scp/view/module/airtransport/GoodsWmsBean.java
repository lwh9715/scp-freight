...
@ManagedBean(name = "pages.module.airtransport.goodswmsBean", scope = ManagedBeanScope.REQUEST)
public class GoodsWmsBean extends FormView {
	...
	public String getJsonByJobid(Long jobid) {
		String sql = "SELECT f_bus_air_goods_wms('jobid="+jobid+"') AS json";
