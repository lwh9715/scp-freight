...
@ManagedBean(name = "pages.module.airtransport.myjobsBean", scope = ManagedBeanScope.REQUEST)
public class MyjobsBean extends GridView{
	...
	public void qryAdd(){
		...
		String url ="/scp/pages/module/airtransport/jobsedit.xhtml";
