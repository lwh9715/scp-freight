...
@ManagedBean(name = "pages.module.ship.jobschildBean", scope = ManagedBeanScope.REQUEST)
...
//		this.grid.reload();
	...
	public void refreshChildMethod(){
        if (this.etd == false && this.eta == false && this.atd == false && this.sonum == false &&
                this.mbl == false && this.porname == false && this.polname == false && this.podname == false &&
