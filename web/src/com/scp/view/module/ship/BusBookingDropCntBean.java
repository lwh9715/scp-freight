...
@ManagedBean(name = "pages.module.ship.busbookingdropcntBean", scope = ManagedBeanScope.REQUEST)
public class BusBookingDropCntBean extends GridFormView {
	...
	public void beforeRender(boolean isPostBack) {
		if (!isPostBack) {
			...
			if(!StrUtils.isNull(id)) {
				...
				this.selectedRowData = serviceContext.busBookingMgrService.busShipBookingDao.findById(this.pkVal);
				showTrace();
			}
		}
	}
...
//		Integer dropcntcount = this.selectedRowData.getDropcntcount();
//		if(dropcntcount == null) {
//			this.selectedRowData.setDropcntcount(1);
//		} else {
//			this.selectedRowData.setDropcntcount(dropcntcount + 1);
//		}
//		try {
			this.serviceContext.busBookingMgrService.saveData(this.selectedRowData);
//			showTrace();
//		} catch(Exception e) {
//			this.selectedRowData.setDropcntcount(dropcntcount);
//		}
