...
@ManagedBean(name = "pages.module.ship.busshippinglclBean", scope = ManagedBeanScope.REQUEST)
...
//	}
	...
	public void ChangCustcontacts(){
		String sql ="select DISTINCT(B.customerabbr) from  sys_corpcontacts S join bus_shipping B  on S.customerid = B.customerid where jobid ="+this.jobid+"";
