...
@ManagedBean(name = "pages.module.ship.containerdetailBean", scope = ManagedBeanScope.REQUEST)
public class ContainerdetailBean extends EditGridView{
	...
	public Map getQryClauseWhere(Map<String, Object> queryMap) {
		...
		qry+="\n AND linkid = " + cid + "OR linkid in (select id from fina_jobs where parentid = (select jobid from bus_ship_container where id = " + cid + " limit 1))";
		m.put("qry", qry);
		return m;
	}
