...
@ManagedBean(name = "pages.module.price.pricecustBean", scope = ManagedBeanScope.REQUEST)
public class PricecustBean extends GridView {
	...
	public void del() {
		...
		this.serviceContext.priceGroupService.removePrice(libid,ids);
		this.alert("OK!");
		this.grid.reload();
	...
	public void chooseBtn() {
		...
		this.serviceContext.priceGroupService.addPrice(libid,ids);
		this.alert("OK!");
		this.grid.reload();
		this.gridFrom.reload();
	}
