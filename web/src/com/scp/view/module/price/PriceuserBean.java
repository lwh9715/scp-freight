...
@ManagedBean(name = "pages.module.price.priceuserBean", scope = ManagedBeanScope.REQUEST)
public class PriceuserBean extends GridView {
...
//	public String tips = "";
	...
	public void del() {
		...
		this.serviceContext.priceGroupService.removeUser(libid,ids);
		this.alert("OK!");
		this.grid.reload();
	...
	public void chooseBtn() {
		...
		this.serviceContext.priceGroupService.addUser(libid,ids);
		//this.alert("OK!");
		this.grid.reload();
		this.gridFrom.reload();
	}
