...
@ManagedBean(name = "pages.module.report.uniteqry.qry_arBean", scope = ManagedBeanScope.REQUEST)
public class Qryar extends GridView {
	...
	public void sortGridRemote(){
		...
		ord = argss;
		this.grid.reload();
		//Browser.execClientScript("reSelectRow()");
	...
	public void doChangeGridPageSize() {
		...
		String url = AppUtils.chaosUrlArs("./qry_ar.xhtml");
