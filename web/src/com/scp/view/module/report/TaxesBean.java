...
@ManagedBean(name = "pages.module.report.taxesBean", scope = ManagedBeanScope.REQUEST)
public class TaxesBean extends GridFormView {
	...
	public void showReportChoosen(String url) {
		...
		dtlIFrame.setSrc("./taxes/" + info + ".xhtml");
