...
@ManagedBean(name = "pages.module.report.service.operroyaltyBean", scope = ManagedBeanScope.REQUEST)
public class OperroyaltyBean {
	...
	public void report() {
		...
		String openUrl = rpturl
				+ "/reportJsp/showReport.jsp?raq=/static/service/oper_royalty.raq";
