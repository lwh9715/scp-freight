...
@ManagedBean(name = "pages.module.report.service.serviceBean", scope = ManagedBeanScope.REQUEST)
public class ServiceBean {
	...
	public void report() {
		...
		String openUrl = rpturl
				+ "/reportJsp/showReport.jsp?raq=/static/service/operator.raq";
