...
@ManagedBean(name = "pages.module.report.boxs.boxspolcompanyBean", scope = ManagedBeanScope.REQUEST)
public class BoxsPolCompanyBean {
	...
	public void report() {
		...
		String openUrl = rpturl
				+ "/reportJsp/showReport.jsp?raq=/static/boxs/CNT_POLCOMPANY.raq";
