...
@ManagedBean(name = "pages.module.report.boxs.boxsmonthBean", scope = ManagedBeanScope.REQUEST)
public class BoxsMonthBean {
	...
	public void report() {
		...
		String openUrl = rpturl
				+ "/reportJsp/showReport.jsp?raq=/static/boxs/CNT.raq";
