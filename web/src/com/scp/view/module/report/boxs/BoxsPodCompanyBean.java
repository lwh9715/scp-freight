...
@ManagedBean(name = "pages.module.report.boxs.boxspodcompanyBean", scope = ManagedBeanScope.REQUEST)
public class BoxsPodCompanyBean {
	...
	public void report() {
		...
		String openUrl = rpturl
				+ "/reportJsp/showReport.jsp?raq=/static/boxs/CNT_PODCOMPANY.raq";
