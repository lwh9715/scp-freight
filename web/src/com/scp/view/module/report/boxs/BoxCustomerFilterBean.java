...
import com.scp.view.module.customer.CustomerChooseBean;
	...
	@ManagedBean(name = "pages.module.report.boxs.boxcustomerfilterBean", scope = ManagedBeanScope.REQUEST)
	public class BoxCustomerFilterBean extends GridView {
		...
		public void report() {
			...
			String openUrl = rpturl
					+ "/reportJsp/showReport.jsp?raq=/static/boxs/CNT_CUSTOMER.raq";
