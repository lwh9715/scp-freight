...
import com.scp.util.StrUtils;
	...
	@ManagedBean(name = "pages.module.report.boxs.boxscustomerBean", scope = ManagedBeanScope.REQUEST)
	public class BoxsCustomerBean {
...
//		public String ppccType;
		...
		public void report() {
			...
			String openUrl = rpturl
					+ "/reportJsp/showReport.jsp?raq=/static/boxs/CNT_CUSTOM.raq";
		...
		public void reportall() {
			...
			if(!StrUtils.isNull(jobno_prefix)) {
				MessageUtils.alert("不过滤单号,请将过滤单号框清空");
				}else{
			String rpturl = AppUtils.getRptUrl();
			String openUrl = rpturl
					+ "/reportJsp/showReport.jsp?raq=/static/boxs/CNT_CUSTOMAll.raq";
			AppUtils.openWindow("_apAllBoxsReport", openUrl + getArgs());
				}
		}
