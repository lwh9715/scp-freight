...
@ManagedBean(name = "pages.module.report.arap.handlecustomerBean", scope = ManagedBeanScope.REQUEST)
public class HandleCustomerBean {
	...
	public void report() {
		...
		String openUrl = rpturl
				+ "/reportJsp/showReport.jsp?raq=/static/arap/ap-all-custom-inster.raq";
