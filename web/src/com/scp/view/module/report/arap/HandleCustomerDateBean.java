...
@ManagedBean(name = "pages.module.report.arap.handlecustomerdateBean", scope = ManagedBeanScope.REQUEST)
public class HandleCustomerDateBean {
	...
	public void report() {
		...
		String openUrl = rpturl
				+ "/reportJsp/showReport.jsp?raq=/static/arap/ap-all-custom-inster2.raq";
