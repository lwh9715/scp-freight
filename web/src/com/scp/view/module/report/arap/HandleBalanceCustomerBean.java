...
@ManagedBean(name = "pages.module.report.arap.handlebalancecustomerBean", scope = ManagedBeanScope.REQUEST)
public class HandleBalanceCustomerBean {
	...
	public void report() {
		...
		String openUrl = rpturl
				+ "/reportJsp/showReport.jsp?raq=/static/arap/ap-all-custom-inster3.raq";
