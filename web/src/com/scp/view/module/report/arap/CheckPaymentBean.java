...
@ManagedBean(name = "pages.module.report.arap.checkpaymentBean", scope = ManagedBeanScope.REQUEST)
public class CheckPaymentBean extends GridView {
	...
	public void report() {
		...
		String openUrl = rpturl
				+ "/reportJsp/showReport.jsp?raq=/static/arap/FK_DZ.raq";
