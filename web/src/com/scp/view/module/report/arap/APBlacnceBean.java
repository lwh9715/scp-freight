...
@ManagedBean(name = "pages.module.report.arap.apblanceBean", scope = ManagedBeanScope.REQUEST)
public class APBlacnceBean {
	...
	public void report() {
		...
		String openUrl = rpturl
				+ "/reportJsp/showReport.jsp?raq=/static/arap/arap-ap.raq";
