...
@ManagedBean(name = "pages.module.report.arap.apblanceallBean", scope = ManagedBeanScope.REQUEST)
public class APBalanceAllBean {
	...
	public void report() {
		...
		String openUrl = rpturl
				+ "/reportJsp/showReport.jsp?raq=/static/arap/arap-all-ap.raq";
