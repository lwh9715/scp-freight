...
@ManagedBean(name = "pages.module.crm.clientdispatchBean", scope = ManagedBeanScope.REQUEST)
public class ClientdispatchBean extends GridView {
	...
	public void exchangeCustomer(){
		...
		String sql = "SELECT f_fina_customer_deploy('customerids="+b.toString()+";saleid="+saleid+";');";
		try {
