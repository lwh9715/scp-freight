...
@ManagedBean(name = "pages.module.other.feejobsBean", scope = ManagedBeanScope.REQUEST)
public class FeeJobs extends GridView {
	...
	@Action
	public void add() {
		String winId = "_edit_fee_jobs";
		String url = "./feejobsedit.xhtml";
	...
	public void grid_ondblclick() {
		...
		String winId = "_edit_fee_jobs";
		String url = "./feejobsedit.xhtml?id="+this.getGridSelectId();
		AppUtils.openWindow(winId, url);
	}
