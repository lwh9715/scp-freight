...
@ManagedBean(name = "pages.module.stock.wmsreportBean", scope = ManagedBeanScope.REQUEST)
public class WmsReportBean extends GridFormView {
	...
	public void showReportChoosen(String url) {
		...
		dtlIFrame.setSrc("./report/"+info+".xhtml");
	...
	protected void doServiceFindData() {
		selectedRowData = serviceContext.sysReportMgrService.sysReportDao.findById(this.pkVal);
