...
@ManagedBean(name = "pages.module.stock.wmsstockcheckBean", scope = ManagedBeanScope.REQUEST)
public class WmsStockCheckBean extends GridView {
	...
	@Action
	public void add() {
		String winId = "_stockcheck_wms";
		String url = "./wmsstockcheckdtl.xhtml";
	...
	public void grid_ondblclick() {
		...
		String winId = "_stockcheck_wms";
		String url = "./wmsstockcheckdtl.xhtml?id="+this.getGridSelectId();
		ApplicationUtilBase.openWindow(winId, url);
	}
