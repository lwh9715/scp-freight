 ...
 *
 */
@ManagedBean(name = "pages.module.stock.report.customerinfeebymonthBean", scope = ManagedBeanScope.REQUEST)
public class CustomerInFeeByMonthBean extends GridView {
	...
	public void report() {
		...
		String openUrl = rpturl
				+ "/reportJsp/showReport.jsp?raq=/stock/cusinfee_by_month.raq";
