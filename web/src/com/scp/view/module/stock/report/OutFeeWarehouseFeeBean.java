 ...
 *
 */
@ManagedBean(name = "pages.module.stock.report.outfeewarehouseBean", scope = ManagedBeanScope.REQUEST)
public class OutFeeWarehouseFeeBean extends GridView {
	...
	public void report() {
		...
		String openUrl = rpturl
				+ "/reportJsp/showReport.jsp?raq=/stock/out-fee-warehouse.raq";
