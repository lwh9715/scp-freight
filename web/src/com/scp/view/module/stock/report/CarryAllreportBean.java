 ...
 *
 */
@ManagedBean(name = "pages.module.stock.report.carryallreportBean", scope = ManagedBeanScope.REQUEST)
public class CarryAllreportBean extends GridView {
	...
	public void report() {
		...
		String openUrl = rpturl
				+ "/reportJsp/showReport.jsp?raq=/stock/out-fee-Allcarry.raq";
