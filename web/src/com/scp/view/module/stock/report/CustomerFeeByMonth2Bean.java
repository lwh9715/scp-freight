 ...
 *
 */
@ManagedBean(name = "pages.module.stock.report.customerfeebymonth2Bean", scope = ManagedBeanScope.REQUEST)
public class CustomerFeeByMonth2Bean extends GridView {
	...
	public void report() {
		...
		String openUrl = rpturl
				+ "/reportJsp/showReport.jsp?raq=/stock/cusfee_by_month2.raq";
