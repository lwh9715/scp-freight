...
@ManagedBean(name = "pages.module.suppliermgr.factorycheckeditmgrBean", scope = ManagedBeanScope.REQUEST)
public class FactoryCheckEitMgrBean extends MastDtlView {
...
//	}
	...
	public void addMaster() {
		...
		selectedRowData.setIsfactory(true);
		//showArapEdit();
		showContact();
	}
	...
	public void audit() {
		...
		ids[0] = String.valueOf(this.selectedRowData.getId());
