...
import com.scp.view.comp.GridView;
	...
	@ManagedBean(name = "pages.module.suppliermgr.customsBean", scope = ManagedBeanScope.REQUEST)
	public class CustomsBean extends GridView {
		...
		public void add() {
			...
			String url = "./customereditmgr.xhtml";
		...
		public void grid_ondblclick() {
			...
			String winId = "_edit_customer";
			String url = "./customereditmgr.xhtml?id="+this.getGridSelectId();
			AppUtils.openWindow(winId, url);
		}
