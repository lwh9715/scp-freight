...
@ManagedBean(name = "pages.module.suppliermgr.officeditBean", scope = ManagedBeanScope.REQUEST)
public class OfficeEditBean extends MastDtlView {
...
//		showArapEdit();
	...
	public void addMaster() {
		...
		selectedRowData.setIscooperative(true);
//		showArapEdit();
		showContact();
		showAccount();
		showVisit();
