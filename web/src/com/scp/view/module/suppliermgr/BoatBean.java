 ...
 * @author CIMC
 */
@ManagedBean(name = "pages.module.suppliermgr.boatBean", scope = ManagedBeanScope.REQUEST)
public class BoatBean extends GridView {
    ...
    public void grid_ondblclick() {
        ...
        String winId = "_edit_customer";
        String url = "./boatedit.xhtml?id="+this.getGridSelectId();
        AppUtils.openWindow(winId, url);
    }
