...
@ManagedBean(name = "pages.module.suppliermgr.clearanceBean", scope = ManagedBeanScope.REQUEST)
public class ClearanceBean extends GridView{
	...
	public void add() {
		...
		String url = "./clearanceedit.xhtml";
	...
	public void grid_ondblclick() {
		...
		String winId = "_edit_customer";
		String url = "./clearanceedit.xhtml?id="+this.getGridSelectId();
		AppUtils.openWindow(winId, url);
	}
