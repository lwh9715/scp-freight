...
import com.scp.view.comp.GridView;
	...
	@ManagedBean(name = "pages.module.suppliermgr.airlineBean", scope = ManagedBeanScope.REQUEST)
	public class AirlineBean extends GridView {
		
		
		@Override
		public void beforeRender(boolean isPostBack) {
			if (!isPostBack) {
				qryMap.put("isairline$", true);
			}
		}
		
		@Action
		public void add() {
			String winId = "_edit_airline";
			String url = "./airlineedit.xhtml";
		...
		public void grid_ondblclick() {
			...
			String winId = "_edit_airline";
			String url = "./airlineedit.xhtml?id="+this.getGridSelectId();
			AppUtils.openWindow(winId, url);
		}
