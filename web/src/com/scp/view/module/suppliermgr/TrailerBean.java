...
import com.scp.view.comp.GridView;
	...
	@ManagedBean(name = "pages.module.suppliermgr.trailerBean", scope = ManagedBeanScope.REQUEST)
	public class TrailerBean extends GridView {
		...
		public void grid_ondblclick() {
			...
			String winId = "_edit_customer";
			String url = "./traileredit.xhtml?id="+this.getGridSelectId();
			AppUtils.openWindow(winId, url);
		}
