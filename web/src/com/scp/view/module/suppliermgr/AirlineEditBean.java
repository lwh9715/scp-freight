...
@ManagedBean(name = "pages.module.suppliermgr.airlineeditBean", scope = ManagedBeanScope.REQUEST)
public class AirlineEditBean extends MastDtlView {
...
//	}
	...
	@Action
	public void showAirtype() {
		try {
			if (this.mPkVal == -1l) {

				String blankUrl = AppUtils.getContextPath()
						+ "/pages/module/common/blank.xhtml";
				airtypeIframe.load(blankUrl);

			} else {
				airtypeIframe.load("../air/airplanetype_link.xhtml?id="+ this.mPkVal);
			}
	...
	public void addMaster() {
		...
		selectedRowData.setIsairline(true);
		showAirtype();
		showContact();
		showAccount();
		showVisit();
