...
@ManagedBean(name = "pages.module.suppliermgr.clearanceeditBean", scope = ManagedBeanScope.REQUEST)
public class ClearanceeditBean extends MastDtlView{
...
//	}
	...
	public void addMaster() {
		...
		selectedRowData.setIstruck(true);
