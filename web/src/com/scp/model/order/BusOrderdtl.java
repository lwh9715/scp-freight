 ...
 *@generated
 */
@Table(name = "bus_orderdtl")
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicInsert = true, dynamicUpdate = true)
@SequenceGenerator(name = "seq_id", sequenceName = "seq_id")
@GenericGenerator(name = "idStrategy", strategy = "native", parameters = { @Parameter(name = "sequence", value = "seq_id") })
public class BusOrderdtl implements java.io.Serializable {
	 ...
	 *@generated
	 */
	@Column(name = "customeridar")
	private java.lang.Long customeridar;

	/**
	 *@generated
	 */
	@Column(name = "customerar", length = 100)
	private java.lang.String customerar;
	
	/**
	 *@generated
	 */
	@Column(name = "customeridap")
	private java.lang.Long customeridap;

	/**
	 *@generated
	 */
	@Column(name = "customerap", length = 100)
	private java.lang.String customerap;
	
	@Column(name = "currencyap", length = 3)
