 ...
 *@generated
 */
@Table(name = "bus_train")
@SuppressWarnings("serial")
@Entity
@org.hibernate.annotations.Entity(dynamicInsert = true, dynamicUpdate = true)
@SequenceGenerator(name = "seq_id", sequenceName = "seq_id")
@GenericGenerator(name = "idStrategy", strategy = "native", parameters = { @Parameter(name = "sequence", value = "seq_id") })
public class BusTrain implements java.io.Serializable {
	...
	@Column(name = "nostackingday")
	private Integer nostackingday;
	
	@Column(name = "stackingfeeday")
	private Integer stackingfeeday;
	
	@Column(name = "isputmbl")
	private boolean isputmbl;

	@Column(name = "putermbl", length = 30)
	private String putermbl;
	
	@Column(name = "puttimembl")
	private java.util.Date puttimembl;

	@Column(name = "putdescmbl")
	private String putdescmbl;
	
	@Column(name = "putstatusmbl", updatable = false)
	private String putstatusmbl;
	
	@Column(name = "deliverytype", length = 30)
	private String deliverytype;
	
	@Column(name = "deliverytypembl", length = 30)
	private String deliverytypembl;
	...
	@Column(name = "mblnombl", length = 30)
	...
	public Integer getNostackingday() {
		return nostackingday;
	}

	public void setNostackingday(Integer nostackingday) {
		this.nostackingday = nostackingday;
	}

	public Integer getStackingfeeday() {
		return stackingfeeday;
	}

	public void setStackingfeeday(Integer stackingfeeday) {
		this.stackingfeeday = stackingfeeday;
	}

	public boolean isIsputmbl() {
		return isputmbl;
	}

	public void setIsputmbl(boolean isputmbl) {
		this.isputmbl = isputmbl;
	}

	public String getPutermbl() {
		return putermbl;
	}

	public void setPutermbl(String putermbl) {
		this.putermbl = putermbl;
	}

	public java.util.Date getPuttimembl() {
		return puttimembl;
	}

	public void setPuttimembl(java.util.Date puttimembl) {
		this.puttimembl = puttimembl;
	}

	public String getPutdescmbl() {
		return putdescmbl;
	}

	public void setPutdescmbl(String putdescmbl) {
		this.putdescmbl = putdescmbl;
	}

	public String getPutstatusmbl() {
		return putstatusmbl;
	}

	public void setPutstatusmbl(String putstatusmbl) {
		this.putstatusmbl = putstatusmbl;
	}
	...
	public String getDeliverytypembl() {
		return deliverytypembl;
	}

	public void setDeliverytypembl(String deliverytypembl) {
		this.deliverytypembl = deliverytypembl;
	}
