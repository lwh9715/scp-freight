...
<body style="align:center">    
  <div id="btns" class='sucaihuo'>
            ...
            <a href="#" onclick="location.href=location.origin + '/scp/reportEdit/file/TemplateEditair.jsp' + location.search;" ><span>调整</span></a>
...
<script language="JavaScript">
	...
	function transUI(){
		var ppccpaytype = $('div[targetid="ppccpaytypepp"]');
		if(ppccpaytype.html() == 'PP'){
			ppccpaytype.html('FREIGHT PREPAID');
		}else if (ppccpaytype.html() == 'CC'){
			ppccpaytype.html('FREIGHT COLLECT');
		}
    }
        	...
        	var isDowm = false;
			  ...
			  function(data){
			  	...
			  	if(data=="''"||data==null){
			  		...
			  		$.get("/scp/service"+location.search+"&src=rogtemplete&action=getViewDataair",
			  		function(data2){
			  			console.log(data2);
			  			var print=new Print({
 									id:"con",
