...
<body style="align:center">    
  <div id="btns" class='sucaihuo'>
            ...
            <a href="#" onclick="location.href=location.origin + '/scp/reportEdit/file/TemplateEdittrainmbl.jsp' + location.search;" ><span class="translate">调整</span></a>
        </div>
        	...
        	var isDowm = false;
			  ...
			  function(data){
			  	...
			  	if(data=="''"||data==null){
			  		...
			  		$.get("/scp/service"+location.search+"&src=rogtemplete&action=getViewDatatrainmbl",
			  		function(data2){
			  			var print=new Print({
 									id:"con",
