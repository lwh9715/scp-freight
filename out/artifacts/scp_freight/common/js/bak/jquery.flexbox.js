/*!
0* jQuery FlexBox $Version: 0.9.6 $
*
...
(function($) {
    $.flexbox = function(div, o) {
        ...
        var $ctr = $('<div></div>')
            ...
            .css('width', o.listWidth + arrowWidth)//20160628 neo width 
            .css('top', o.top)//20160704 bruce 暂时写死top，原值top
            .css('left', o.left)
        ...
        function processKeyDown(e) {
            ...
            if ((/27$|38$|33$|34$|37$|39$/.test(e.keyCode) && $ctr.is(':visible')) ||
                ...
                switch (e.keyCode) {
                    ...
                    case 13: // enter
                        if (getCurr()){//有内容
                        	...
                        	try {
                                if (typeof(eval(jumpToNextRow)) == "function") {
                                	jumpToNextRow(this);
                                }else{
                                	flexboxDelay(true);
                                }
        ...
        function flexbox(p, arrowOrPagingClicked, prevQuery) {
            ...
            if (q.length >= o.minChars || arrowOrPagingClicked) {
                ...
                if (cached) {
                    ...
                    var params = { q: encodeURIComponent(q), p: p, s: pageSize, contentType: 'application/json; charset=utf-8' };
		...
		function filter(data, params) {
			...
			for (var i=0; i < data[o.resultsProperty].length; i++) {
				var indexOfMatch = data[o.resultsProperty][i][o.displayValueExt1].toLowerCase().indexOf(params.q.toLowerCase());
				if ((o.matchAny && indexOfMatch !== -1) || (!o.matchAny && indexOfMatch === 0)) {
					filtered[o.resultsProperty][index++] = data[o.resultsProperty][i];
					filtered[o.totalProperty] += 1;
				}
			...
			for (var i=0; i < data[o.resultsProperty].length; i++) {
				var indexOfMatch = data[o.resultsProperty][i][o.displayValueExt2].toLowerCase().indexOf(params.q.toLowerCase());
				if ((o.matchAny && indexOfMatch !== -1) || (!o.matchAny && indexOfMatch === 0)) {
					filtered[o.resultsProperty][index++] = data[o.resultsProperty][i];
					filtered[o.totalProperty] += 1;
				}
    ...
    $.fn.flexbox.defaults = {
        ...
        queryDelay: 150, // num of milliseconds before query is run.
        ...
        noResultsText: 'No results found', // text to show when no results match the query
        ...
        displayValue: 'name', //  name为code json element whose value is displayed on select
        displayValueExt1: 'namec', // namec为name中文名
        displayValueExt2: 'namee', // namee为英文名
        ...
        position:'absolute',//20160704 bruce 新增属性，定位布局设置，默认相对定位
        top:'22px',//20160704 bruce 新增属性 绝对定位时顶部距离
        left:'0px',//20160704 bruce 新增属性 绝对定位时左边距离
        listWidth:600,//20160705 bruce 新增属性 下拉列表宽度，默认600
        paging: {
            ...
            //summaryTemplate: '第{start}-{end}条/共{total}条    [第{page}页/共{pages}页]   \t←→:翻页 ↑↓:移动光标 Enter:选择 Escape:隐藏' // can use {page} and {pages} as well
            summaryTemplate: '{start}-{end}/{total}    [{page}/{pages}]   \t←→↑↓ Enter,Esc' // can use {page} and {pages} as well
        }
    };
