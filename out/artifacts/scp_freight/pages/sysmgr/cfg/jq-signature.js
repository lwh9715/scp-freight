...
//        });
                ...
                '<div class="modal-content">' +
                    ...
                    '<div class="modal-body">' +
                        '<div class="js-signature" id="mySignature">' +
                         '</div>' +
                         '<div>' +
                         '<button type="button" class="btn btn-default" id="myEmpty">Clear</button>' +
                         '<button type="button" class="btn btn-default" id="myBackColor">Background Color</button>' +
                         //'<div style="position:absolute;relative">' +
                         '<button type="button" class="btn btn-default" id="myColor">Font Color</button>' +
                    ...
                    '<div class="modal-footer">' +
                        ...
                        '<button type="button" class="btn btn-default" id="myClose">Close</button>' +
                        '<button type="button" class="btn btn-primary" id="mySave" onclick="savaimg();" >Save</button>' +
                        '<div id="myImg">' +
                        '<div>' +
    ...
    function initTable() {
        ...
        '<td width="3"><input type="text" name="HexColor" size="7" style="border:inset 1px;font-family:Arial;" value="#000000"></td>' +
         '<td width="3"><button type="button" class="btn btn-primary btn-sm" id="btnSave">OK</button></td>' +
        '</tr>' +
        '</table>' +
    ...
    function initSignature() {
        ...
        if (window.requestAnimFrame) {
            ...
            signature.jqSignature({ width: 500, height: 200, border: '1px solid red', background: '#16A085', lineColor: '#ABCDEF', lineWidth: 5, autoFit: false });
            //{ width: 600, height: 200, border: '1px solid red', background: '#16A085', lineColor: '#ABCDEF', lineWidth: 2, autoFit: true }
        } else {

            alert("Please load jq-signature.js");
            return;
        }
    }
